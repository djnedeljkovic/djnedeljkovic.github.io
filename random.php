...
<!-- ============ Page Heading ============== -->
<h1 class="HeadingStyle">This random page is made for random selection  :) </h1>

<!-- ============ Begin Content ============== -->
<form><input type=button value="Randomize" onClick="window.location.reload()"></form>
Who will do this?
<?php
	echo("<img src=\"./images/programeri/programer");
        echo rand(1, 6);   
        echo(".jpg\" alt=\"I couldn't find any mad programmer :)\" />"); 
?>
<br />

Where do we eat? 
<?php
	echo("<img src=\"./images/food/food");
        echo rand(1, 4);   
        echo(".jpg\" alt=\"I couldn't find any food place :)\" />"); 
?>
<!-- ============ End Content ============== -->
</td>
